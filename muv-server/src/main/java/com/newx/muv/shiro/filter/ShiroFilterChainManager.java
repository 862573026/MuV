...
import com.newx.muv.shiro.config.RestPathMatchingFilterChainResolver;
...
public class ShiroFilterChainManager {
    ...
    public Map<String,String> initGetFilterChain() {
        ...
        List<String> jwtAuth = Arrays.asList("/jwt/**");
        jwtAuth.forEach(auth -> filterChain.put(auth,"jwt"));
        // -------------dynamic 动态URL
