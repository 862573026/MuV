...
import com.newx.muv.util.encrypt.Encoder;
import com.newx.muv.util.encrypt.methods.AES;
...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "newxHaHaHaHa";
    ...
    public static String aesDecode(String content, String tokenKey) {
