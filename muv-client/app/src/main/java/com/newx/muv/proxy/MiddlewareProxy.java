...
public class MiddlewareProxy {
    ...
    private final static RuntimeDataManager mRuntimeDataManager = new RuntimeDataManager();

    public static RuntimeDataManager getRuntimeDataManager() {
