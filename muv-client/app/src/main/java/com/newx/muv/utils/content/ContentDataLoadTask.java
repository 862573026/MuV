package com.newx.muv.utils.content;
...
public class ContentDataLoadTask extends AsyncTask<Void, Void, Void> {
    ...
    private List<FileItem> getAllPhoto() {
        ...
        while (cursor.moveToNext()) {
            ...
            NXLog.e( imageId + " -- " + fileName + " -- " + filePath);
    ...
    private List<FileItem> getAllMusic() {
        ...
        while (cursor.moveToNext()) {
            ...
            NXLog.e(fileId + " -- " + fileName + " -- " + filePath);
    ...
    private List<FileItem> getAllText() {
        ...
        while (cursor.moveToNext()) {
            ...
            NXLog.e( fileId + " -- " + fileName + " -- " + "--" + cursor.getString(cursor.getColumnIndex(MediaStore.Files.FileColumns.MIME_TYPE)) + filePath);
