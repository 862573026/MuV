package com.newx.base.frameworks.route.launcher;
...
import com.newx.base.frameworks.route.core.InstrumentationHook;
import com.newx.base.frameworks.route.core.LogisticsCenter;
import com.newx.base.frameworks.route.exception.HandlerException;
import com.newx.base.frameworks.route.exception.InitException;
...
import com.newx.base.frameworks.route.facade.callback.NavigationCallback;
import com.newx.base.frameworks.route.facade.service.AutowiredService;
import com.newx.base.frameworks.route.facade.service.DegradeService;
import com.newx.base.frameworks.route.facade.service.InterceptorService;
import com.newx.base.frameworks.route.facade.service.PathReplaceService;
import com.newx.base.frameworks.route.facade.template.ILogger;
import com.newx.base.frameworks.route.thread.DefaultPoolExecutor;
import com.newx.base.frameworks.route.utils.Consts;
import com.newx.base.frameworks.route.utils.DefaultLogger;
    ...
    protected Object navigation(final Context context, final Postcard postcard, final int requestCode, final NavigationCallback callback) {
        try {
            ...
            if (debuggable()) { // Show friendly tips for user.
                Toast.makeText(mContext, "There's no com.newx.base.frameworks.route matched!\n" +
        ...
        if (!postcard.isGreenChannel()) {   // It must be run in async thread, maybe interceptor cost too mush time made ANR.
            interceptorService.doInterceptions(postcard, new InterceptorCallback() {
                 ...
                 * Continue process
                 *
                 * @param postcard com.newx.base.frameworks.route meta
                 */
                @Override
