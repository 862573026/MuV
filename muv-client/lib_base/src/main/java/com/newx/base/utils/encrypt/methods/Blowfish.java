...
package com.newx.base.utils.encrypt.methods;

import javax.crypto.Cipher;
import javax.crypto.spec.IvParameterSpec;
import javax.crypto.spec.SecretKeySpec;

import com.newx.base.utils.encrypt.Base64;
import com.newx.base.utils.encrypt.constants.Constants;
import com.newx.base.utils.encrypt.constants.Padding;
...
public class Blowfish extends BaseMethod{
    ...
    public static class MethodCFB extends MethodMode {
        ...
        public static MethodCFB generateMethod(int methodNumber, Padding padding){
            if(checkNumber(methodNumber)){
                return new MethodCFB(BLOWFISH_CFB + methodNumber + "/" + padding.getPadding());
            } else {
                return null;
            }
        }
    ...
    public static class MethodOFB extends MethodMode {
        ...
        public static MethodOFB generateMethod(int methodNumber, Padding padding){
            if(checkNumber(methodNumber)){
                return new MethodOFB(BLOWFISH_OFB + methodNumber + "/" + padding.getPadding());
            } else {
                return null;
            }
        }
