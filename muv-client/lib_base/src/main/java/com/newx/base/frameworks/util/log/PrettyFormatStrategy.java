...
//    }
    ...
    @Override
    public void log(int priority, @Nullable String onceOnlyTag, @NonNull String message, @NonNull boolean needPrintStack) {
    ...
    private int getStackOffset(@NonNull StackTraceElement[] trace) {
        ...
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(NXLogPrinter.class.getName()) && !name.equals(NXLog.class.getName())) {
                return --i;
            }
        }
        return -1;
