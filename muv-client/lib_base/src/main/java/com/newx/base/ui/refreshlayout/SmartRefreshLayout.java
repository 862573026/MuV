package com.newx.base.ui.refreshlayout;
...
import com.newx.base.ui.refreshlayout.api.DefaultRefreshFooterCreator;
import com.newx.base.ui.refreshlayout.api.DefaultRefreshHeaderCreator;
import com.newx.base.ui.refreshlayout.api.RefreshContent;
import com.newx.base.ui.refreshlayout.api.RefreshFooter;
import com.newx.base.ui.refreshlayout.api.RefreshHeader;
import com.newx.base.ui.refreshlayout.api.RefreshInternal;
import com.newx.base.ui.refreshlayout.api.RefreshKernel;
import com.newx.base.ui.refreshlayout.api.RefreshLayout;
import com.newx.base.ui.refreshlayout.api.ScrollBoundaryDecider;
import com.newx.base.ui.refreshlayout.constant.DimensionStatus;
import com.newx.base.ui.refreshlayout.constant.RefreshState;
import com.newx.base.ui.refreshlayout.constant.SpinnerStyle;
import com.newx.base.ui.refreshlayout.footer.BallPulseFooter;
import com.newx.base.ui.refreshlayout.header.BezierRadarHeader;
import com.newx.base.ui.refreshlayout.impl.RefreshContentWrapper;
import com.newx.base.ui.refreshlayout.impl.RefreshFooterWrapper;
import com.newx.base.ui.refreshlayout.impl.RefreshHeaderWrapper;
...
import com.newx.base.ui.refreshlayout.listener.OnRefreshLoadMoreListener;
import com.newx.base.ui.refreshlayout.listener.OnStateChangedListener;
import com.newx.base.ui.refreshlayout.util.DelayedRunnable;
import com.newx.base.ui.refreshlayout.util.DensityUtil;
import com.newx.base.ui.refreshlayout.util.ScrollBoundaryUtil;
import com.newx.base.ui.refreshlayout.util.ViscousFluidInterpolator;
...
import static com.newx.base.ui.refreshlayout.util.DensityUtil.dp2px;
import static com.newx.base.ui.refreshlayout.util.SmartUtil.fling;
import static com.newx.base.ui.refreshlayout.util.SmartUtil.getColor;
import static com.newx.base.ui.refreshlayout.util.SmartUtil.isScrollableView;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.newx.base.ui.refreshlayout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.newx.base.ui.refreshlayout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
