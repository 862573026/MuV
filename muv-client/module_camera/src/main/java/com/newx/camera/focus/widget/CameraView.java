...
import com.newx.utils.utilcode.util.ToastUtils;
 ...
 * @date 2015-09-24
 */
public class CameraView extends SurfaceView implements SurfaceHolder.Callback, ICameraOperation, IActivityLifeCycle {
...
//        params.topMargin = -(height - width) / 2;
    ...
    private void setUpCamera(CameraManager.CameraDirection mCameraId, boolean isSwitchFromFront) {
        ...
        try {
            ...
            ToastUtils.showShort(R.string.tips_camera_forbidden);
            e.printStackTrace();
        }
        if (mCamera != null) {
            try {
...
//            toast("切换失败，请重试！", Toast.LENGTH_LONG);
    ...
    /**
     * When orientation changes, onOrientationChanged(int) of the com.newx.media.listener will be called
     */
