...
import com.newx.media.cache.file.FileCache;
...
import static com.newx.media.cache.ProxyCacheUtils.DEFAULT_BUFFER_SIZE;
...
class HttpProxyCache extends ProxyCache {
    ...
    private boolean isUseCache(GetRequest request) throws ProxyCacheException {
        ...
        // do not use com.newx.media.cache for partial requests which too far from available com.newx.media.cache. It seems user seek com.newx.media.video.
