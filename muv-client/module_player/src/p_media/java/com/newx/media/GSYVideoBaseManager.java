...
import com.newx.media.cache.CacheListener;
import com.newx.media.cache.HttpProxyCacheServer;
import com.newx.media.cache.file.Md5FileNameGenerator;
import com.newx.media.cache.headers.HeaderInjector;
import com.newx.media.listener.GSYMediaPlayerListener;
import com.newx.media.model.GSYModel;
import com.newx.media.model.VideoOptionModel;
import com.newx.media.player.EXO2PlayerManager;
import com.newx.media.player.IJKPlayerManager;
import com.newx.media.player.IPlayerManager;
import com.newx.media.player.SystemPlayerManager;
import com.newx.media.utils.CommonUtil;
import com.newx.media.utils.Debuger;
import com.newx.media.utils.FileUtils;
import com.newx.media.utils.GSYVideoType;
import com.newx.media.utils.StorageUtils;
import com.newx.media.video.base.GSYVideoViewBridge;
...
public abstract class GSYVideoBaseManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener,
    ...
    public static String TAG = "com.newx.media.GSYVideoBaseManager";
    ...
    //header for com.newx.media.cache
    ...
    private Runnable mTimeOutRunnable = new Runnable() {
        ...
        public void run() {
            if (listener != null) {
                Debuger.printfError("time out for error com.newx.media.listener");
    ...
    /**
     * for android com.newx.media.video com.newx.media.cache header
     */
