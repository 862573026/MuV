...
import com.newx.media.cache.file.Md5FileNameGenerator;
import com.newx.media.cache.file.TotalCountLruDiskUsage;
import com.newx.media.cache.file.TotalSizeLruDiskUsage;
import com.newx.media.cache.headers.EmptyHeadersInjector;
import com.newx.media.cache.headers.HeaderInjector;
import com.newx.media.cache.sourcestorage.SourceInfoStorage;
import com.newx.media.cache.sourcestorage.SourceInfoStorageFactory;
...
import static com.newx.media.cache.Preconditions.checkAllNotNull;
import static com.newx.media.cache.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            HttpProxyCacheDebuger.printfLog("Proxy com.newx.media.cache server started. Is it alive? " + isAlive());
     ...
     * @return a wrapped by proxy url if file is not fully cached or url pointed to com.newx.media.cache file otherwise.
     */
     ...
     * @return a wrapped by proxy url if file is not fully cached or url pointed to com.newx.media.cache file otherwise (if {@code allowCachedFileUri} is {@code true}).
     */
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                HttpProxyCacheDebuger.printfWarning("Error registering com.newx.media.cache com.newx.media.listener", e.getMessage());
            }
        }
    }
    ...
    /**
     * Checks is com.newx.media.cache contains fully cached file for particular url.
     *
     * @param url an url com.newx.media.cache file will be checked for.
     * @return {@code true} if com.newx.media.cache contains fully cached file for passed in parameters url.
     */
    ...
    public static final class Builder {
        ...
        /**
         * Overrides default com.newx.media.cache folder to be used for caching files.
         * <p>
         * By default AndroidVideoCache uses
         * '/Android/data/[app_package_name]/com.newx.media.cache/com.newx.media.video-com.newx.media.cache/' if card is mounted and app has appropriate permission
         * or 'com.newx.media.video-com.newx.media.cache' subdirectory in default application's com.newx.media.cache directory otherwise.
         * </p>
         * <b>Note</b> directory must be used <b>only</b> for AndroidVideoCache files.
         *
         * @param file a com.newx.media.cache directory, can't be null.
         * @return a com.newx.media.builder.
         */
        ...
        /**
         * Overrides default com.newx.media.cache file name generator {@link Md5FileNameGenerator} .
         *
        ...
        /**
         * Sets max com.newx.media.cache size in bytes.
         * <p>
         ...
         *
         * @param maxSize max com.newx.media.cache size in bytes.
         * @return a com.newx.media.builder.
         */
        ...
        /**
         * Sets max com.newx.media.cache files count.
         * All files that exceeds limit will be deleted using LRU strategy.
         * Note this method overrides result of calling {@link #maxCacheSize(long)}
         *
         * @param count max com.newx.media.cache files count.
         * @return a com.newx.media.builder.
         */
        ...
        /**
         * Set custom DiskUsage logic for handling when to keep or clean com.newx.media.cache.
         *
         ...
         *
         * @return proxy com.newx.media.cache. Only single instance should be used across whole app.
         */
