...
final class StorageUtils {
    ...
    private static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            HttpProxyCacheDebuger.printfWarning("Can't define system com.newx.media.cache directory! '" + cacheDirPath + "%s' will be used.");
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                HttpProxyCacheDebuger.printfWarning("Unable to create external com.newx.media.cache directory");
                return null;
            }
        }
        return appCacheDir;
