...
import com.newx.media.cache.HttpProxyCacheDebuger;
...
/**
 * {@link DiskUsage} that uses LRU (Least Recently Used) strategy to trim com.newx.media.cache.
 *
        ...
        for (File file : files) {
            ...
            if (!accepted) {
                ...
                if (deleted) {
                    totalCount--;
                    totalSize -= fileSize;
                    HttpProxyCacheDebuger.printfLog("Cache file " + file + " is deleted because it exceeds com.newx.media.cache limit");
                } else {
                    HttpProxyCacheDebuger.printfError("Error deleting file " + file + " for trimming com.newx.media.cache");
                }
            }
        }
    }
