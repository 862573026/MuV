package com.newx.media.cache.file;

import com.newx.media.cache.Cache;
import com.newx.media.cache.ProxyCacheException;
...
public class FileCache implements Cache {
    ...
    public FileCache(File file, DiskUsage diskUsage) throws ProxyCacheException {
        try {
            ...
            throw new ProxyCacheException("Error using file " + file + " as disc com.newx.media.cache", e);
        }
    }
    ...
    public synchronized void append(byte[] data, int length) throws ProxyCacheException {
        try {
            if (isCompleted()) {
                throw new ProxyCacheException("Error append com.newx.media.cache: com.newx.media.cache file " + file + " is completed!");
            }
    ...
    public synchronized void complete() throws ProxyCacheException {
        ...
        try {
            ...
            throw new ProxyCacheException("Error opening " + file + " as disc com.newx.media.cache", e);
        }
    }
    ...
    /**
     * Returns file to be used fo caching. It may as original file passed in constructor as some temp file for not completed com.newx.media.cache.
     *
