...
import com.newx.media.utils.CommonUtil;
import com.newx.media.utils.Debuger;
import com.newx.media.utils.OrientationUtils;
import com.newx.media.view.SmallVideoTouch;
import com.newx.utils.def.DEFAULT;
import com.transitionseverywhere.TransitionManager;

import java.lang.reflect.Constructor;

import static com.newx.media.utils.CommonUtil.getActionBarHeight;
import static com.newx.media.utils.CommonUtil.getStatusBarHeight;
import static com.newx.media.utils.CommonUtil.hideNavKey;
import static com.newx.media.utils.CommonUtil.hideSupportActionBar;
import static com.newx.media.utils.CommonUtil.showNavKey;
import static com.newx.media.utils.CommonUtil.showSupportActionBar;
...
//    public GSYBaseVideoPlayer showSmallVideo(SmallVideoPlayerSetting setting) {
//        return showSmallVideo(size, null, actionBar, statusBar);
//    }
//
//    /**
//     * 显示小窗口
...
//     * @return
//     */
//    public GSYBaseVideoPlayer showSmallVideo(Point size, Point locate, final boolean actionBar, final boolean statusBar) {
//        return showSmallVideo(size, locate, actionBar, statusBar, false);
//    }
...
//     * @return
//     */
//    public GSYBaseVideoPlayer showSmallVideo(Point size, Point locate, final boolean actionBar, final boolean statusBar, boolean movable) {
//
//        final ViewGroup vp = getViewGroup();
//
...
//
//            int marginLeft = CommonUtil.getScreenWidth(mContext) - size.x; //默认靠右边，合逻辑一点
//            int marginTop = 0;
//            if (locate != null) {
//                marginLeft = locate.x;
//                marginTop = locate.y;
...
//            gsyVideoPlayer.setVideoAllCallBack(mVideoAllCallBack);
//
//            int scrollLeft = CommonUtil.getScreenWidth(mContext) - size.x;
//            int scrollTop = CommonUtil.getScreenHeight(mContext) - size.y;
//
//            if (movable) {
//                gsyVideoPlayer.setSmallVideoTextureView(new SmallVideoTouch(gsyVideoPlayer, scrollLeft, scrollTop));
//            }
//
//            getGSYVideoManager().setLastListener(this);
//            getGSYVideoManager().setListener(gsyVideoPlayer);
...
//    }
    ...
    public GSYBaseVideoPlayer showSmallVideo(SmallVideoPlayerSetting setting) {
        ...
        int width = (setting.width == DEFAULT.LENGTH ? DEFAULT.LENGTH : setting.width);
        int height = (setting.height == DEFAULT.LENGTH ? DEFAULT.LENGTH : setting.height);
        int marginLeft = (setting.marginLeft == DEFAULT.LENGTH ? DEFAULT.LENGTH : CommonUtil.getScreenWidth(mContext) - setting.width); //默认靠右边，合逻辑一点
        int marginTop = (setting.marginTop == DEFAULT.LENGTH ? DEFAULT.LENGTH : setting.marginTop);
        ...
        try {
            ...
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(setting.width, setting.height);


            if (setting.hasActionBar) {
                marginTop = marginTop - getActionBarHeight((Activity) mContext);
            }

            if (setting.hasStatusBar) {
                marginTop = marginTop - getStatusBarHeight(mContext);
            }
            ...
            //可滑动的
            int scrollLeft = CommonUtil.getScreenWidth(mContext) - width;
            int scrollTop = CommonUtil.getScreenHeight(mContext) - height;
...
//            }
//
//            public Builder setHastatusBar(boolean hasStatusBar) {
//                this.hasStatusBar = hasStatusBar;
//                return this;
//            }
//
...
//                SmallVideoPlayerSetting com.newx.media.player = buildPlayer();
//                return com.newx.media.player;
//            }
//        }
//    }
}
