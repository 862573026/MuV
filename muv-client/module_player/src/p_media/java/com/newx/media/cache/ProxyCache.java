 ...
 * Useful for streaming something with caching e.g. streaming com.newx.media.video/audio etc.
 *
...
class ProxyCache {
    ...
    private void onSourceRead() {
        // guaranteed notify listeners after source read and com.newx.media.cache completed
        percentsAvailable = 100;
