...
import com.newx.media.utils.NetInfoModule;
...
import static com.newx.media.utils.CommonUtil.getTextSpeed;
...
public abstract class GSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    protected void netWorkErrorLogic() {
        ...
        Debuger.printfError("******* Net State Changed. renew com.newx.media.player to connect *******" + currentPosition);
