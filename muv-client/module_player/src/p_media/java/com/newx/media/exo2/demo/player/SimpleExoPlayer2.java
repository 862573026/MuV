 ...
 */
package com.newx.media.exo2.demo.player;
...
public class SimpleExoPlayer2 implements ExoPlayer {
  ...
  public interface VideoListener {
     ...
     * frame is rendered for the first time since a com.newx.media.video track was selected.
     */
  ...
  public SimpleExoPlayer2(RenderersFactory renderersFactory, TrackSelector trackSelector,
    ...
    // Obtain counts of com.newx.media.video and audio renderers.
    ...
    // Build the com.newx.media.player and associated objects.
  ...
  /**
   * Returns the com.newx.media.video scaling mode.
   */
  ...
  /**
   * Returns the com.newx.media.video format currently being played, or null if no com.newx.media.video is being played.
   */
  ...
  /**
   * Adds a com.newx.media.listener to receive com.newx.media.video events.
   *
   * @param listener The com.newx.media.listener to register.
   */
  ...
  /**
   * Removes a com.newx.media.listener of com.newx.media.video events.
   *
   * @param listener The com.newx.media.listener to unregister.
   */
  ...
  /**
   * Sets a com.newx.media.listener to receive debug events from the com.newx.media.video renderer.
   *
   * @param listener The com.newx.media.listener.
   */
  ...
  /**
   * Sets a com.newx.media.listener to receive debug events from the audio renderer.
   *
   * @param listener The com.newx.media.listener.
   */
