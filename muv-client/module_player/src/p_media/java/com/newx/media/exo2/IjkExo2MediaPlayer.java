...
import com.newx.media.exo2.demo.EventLogger;
import com.newx.media.exo2.demo.player.SimpleExoPlayer2;
...
public class IjkExo2MediaPlayer extends AbstractMediaPlayer implements Player.EventListener,
    ...
    public void prepareAsync() throws IllegalStateException {
        if (mInternalPlayer != null)
            throw new IllegalStateException("can't prepare a prepared com.newx.media.player");
