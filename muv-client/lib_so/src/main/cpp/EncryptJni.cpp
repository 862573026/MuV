...
Java_com_newx_jni_EncryptJni_jniencrypt(JNIEnv *env, jclass type, jbyteArray jbArr) {
...
Java_com_newx_jni_EncryptJni_jnidecrypt(JNIEnv *env, jclass type, jstring out_str) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_newx_jni_EncryptJni_pwdMD5(JNIEnv *env, jclass type, jstring out_str) {
