...
public class CameraManager implements ICameraHelper {
    ...
    private CameraManager(Context context) {
        ...
        mLightStatus = FlashLigthStatus.valueOf((Integer) SPUtil.get(SPConfig.KEY_LIGHT_STATUE, FlashLigthStatus.LIGHT_AUTO.ordinal())); //默认 自动
        mFlashDirection = CameraDirection.valueOf((Integer) SPUtil.get(SPConfig.KEY_CAMERA_DIRECTION, CameraDirection.CAMERA_BACK.ordinal())); //默认后置摄像头
    }
    ...
    public void setLightStatus(FlashLigthStatus mLightStatus) {
        ...
        if (m_tvFlashLight != null) {
            ...
            SPUtil.put(SPConfig.KEY_LIGHT_STATUE, mLightStatus.ordinal());
        }
    }
    ...
    public void setCameraDirection(CameraDirection mFlashDirection) {
        ...
        if (m_tvCameraDireation != null) {
            ...
            SPUtil.put(SPConfig.KEY_CAMERA_DIRECTION, mFlashDirection.ordinal());
