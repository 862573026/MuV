...
import com.newx.media.builder.GSYVideoOptionBuilder;
import com.newx.media.listener.GSYVideoProgressListener;
import com.newx.media.listener.LockClickListener;
import com.newx.media.listener.VideoAllCallBack;
import com.newx.media.render.view.GSYVideoGLView;
import com.newx.media.video.StandardGSYVideoPlayer;
import com.newx.media.video.base.GSYBaseVideoPlayer;
import com.newx.media.video.base.GSYVideoPlayer;
import com.newx.media.video.base.SmallVideoPlayerSetting;
...
public class GSYVideoHelper {
     ...
     * 显示小屏幕效果
     */
    public void showSmallVideo(SmallVideoPlayerSetting setting) {
        if (mGsyVideoPlayer.getCurrentState() == GSYVideoPlayer.CURRENT_STATE_PLAYING) {
            mGsyVideoPlayer.showSmallVideo(setting);
            isSmall = true;
        }
    }
