package com.newx.common.widget.morphytoolbar;
...
import com.newx.common.widget.CircleImageView;
...
public class MorphyToolbar extends FrameLayout {
    ...
    private void inflate() {
        final View view = inflate(getContext(), R.layout.layout_morphy_toolbar, this);
        innerLayout = view.findViewById(R.id.mt_layout_toolbar);
        imgPicture = innerLayout.findViewById(R.id.mt_img_picture);
        titleLayout = innerLayout.findViewById(R.id.mt_layout_title);

        lblTitle = titleLayout.findViewById(R.id.mt_lbl_title);
        lblSubtitle = titleLayout.findViewById(R.id.mt_lbl_subtitle);

        setId(R.id.mt_morphy_toolbar);
    }

    /**
     * Replace the toolbar in the activity com.newx.media.view by the MorphyToolbar, wrapping the toolbar
     */
    ...
    /**
     * Expand the com.newx.media.view without changing the toolbar/status bar background color
     */
    public void expand() {
