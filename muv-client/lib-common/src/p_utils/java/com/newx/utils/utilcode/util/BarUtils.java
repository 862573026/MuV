 ...
 *     time  : 2016/09/23
 *     desc  : com.newx.media.utils about bar
 * </pre>
 */
public final class BarUtils {
    ...
    /**
     * Add the top margin size equals status bar's height for com.newx.media.view.
     *
    ...
    /**
     * Subtract the top margin size equals status bar's height for com.newx.media.view.
     *
     * @param view The com.newx.media.view.
     */
     ...
     * Set the status bar's color.
     *
     * @param fakeStatusBar The fake status bar com.newx.media.view.
     * @param color         The status bar's color.
     */
