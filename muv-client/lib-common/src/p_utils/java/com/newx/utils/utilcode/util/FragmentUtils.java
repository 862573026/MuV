 ...
 *     time  : 2017/01/17
 *     desc  : com.newx.media.utils about fragment
 * </pre>
 */
public final class FragmentUtils {
     ...
     *                    com.newx.media.view of the fragment being added or attached.
     * @param exitAnim    An animation or animator resource ID used for the exit animation on the
     *                    com.newx.media.view of the fragment being removed or detached.
     */
    public static void add(@NonNull final FragmentManager fm,
                           @NonNull final Fragment add,
                           @IdRes final int containerId,
     ...
     *                     com.newx.media.view of the fragment being readded or reattached caused by
     ...
     *                     com.newx.media.view of the fragment being removed or detached caused by
     *                     popBackStack() or similar methods.
     */
    public static void add(@NonNull final FragmentManager fm,
                           @NonNull final Fragment add,
