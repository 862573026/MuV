...
import com.newx.ui.fragmentation.helper.ExceptionHandler;
...
public class Fragmentation {
    /**
     * Dont display stack com.newx.media.view.
     */
    public static final int NONE = 0;
    /**
     * Shake it to display stack com.newx.media.view.
     */
    public static final int SHAKE = 1;
    /**
     * As a bubble display stack com.newx.media.view.
     */
    ...
    public static class FragmentationBuilder {
        ...
        /**
         * Sets the mode to display the stack com.newx.media.view
         *
         * None if debug(false).
         *
         * Default:NONE
