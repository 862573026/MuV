package com.newx.ui.searchview.util.view;
...
import com.newx.ui.searchview.util.MenuPopupHelper;
...
/**
 * A com.newx.media.view that shows menu items as actions or
...
public class MenuView extends LinearLayout {
    ...
    public MenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ACTION_DIMENSION_PX = context.getResources().getDimension(R.dimen.dp_48);
        init();
    }
    ...
    private void init() {
        ...
        mActionIconColor = Util.getColor(getContext(), R.color.gray_78);
        mOverflowIconColor = Util.getColor(getContext(), R.color.gray_78);
    }
    ...
    /**
     * Resets the the com.newx.media.view to fit into a new
     * available width.
     * <p/>
    ...
    public void reset(int menu, int availWidth) {
        ...
        //clean com.newx.media.view and re-inflate
        removeAllViews();
    ...
    private ImageView createActionView() {
        return (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.item_searchview_action, this, false);
    }

    private ImageView getOverflowActionView() {
        return (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.item_searchview_overflow_action, this, false);
    }
