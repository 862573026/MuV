...
import com.newx.ui.fragmentation.anim.DefaultVerticalAnimator;
import com.newx.ui.fragmentation.anim.FragmentAnimator;
import com.newx.ui.fragmentation.debug.DebugStackDelegate;

/**
 * 代理模式，把一些功能代理出来，减少Base类的重量，并且可以实现多继承
 */
