package com.newx.ui.refreshlayout.util;
...
//    public static boolean pointInView(View com.newx.media.view, float localX, float localY, float slop) {
//        final float left = /*Math.max(com.newx.media.view.getPaddingLeft(), 0)*/ - slop;
//        final float top = /*Math.max(com.newx.media.view.getPaddingTop(), 0)*/ - slop;
//        final float width = com.newx.media.view.getWidth()/* - Math.max(com.newx.media.view.getPaddingLeft(), 0) - Math.max(com.newx.media.view.getPaddingRight(), 0)*/;
//        final float height = com.newx.media.view.getHeight()/* - Math.max(com.newx.media.view.getPaddingTop(), 0) - Math.max(com.newx.media.view.getPaddingBottom(), 0)*/;
