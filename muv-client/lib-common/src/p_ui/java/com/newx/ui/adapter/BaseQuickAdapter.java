...
import com.newx.ui.adapter.animation.AlphaInAnimation;
import com.newx.ui.adapter.animation.BaseAnimation;
import com.newx.ui.adapter.animation.ScaleInAnimation;
import com.newx.ui.adapter.animation.SlideInBottomAnimation;
import com.newx.ui.adapter.animation.SlideInLeftAnimation;
import com.newx.ui.adapter.animation.SlideInRightAnimation;
import com.newx.ui.adapter.entity.IExpandable;
import com.newx.ui.adapter.loadmore.LoadMoreView;
import com.newx.ui.adapter.loadmore.SimpleLoadMoreView;
import com.newx.ui.adapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * Load more com.newx.media.view count
     *
     * @return 0 or 1
     */
     ...
     * Refresh end, no more data
     *
     * @param gone if true gone the load more com.newx.media.view
     */
    ...
    /**
     * If you have added headeview, the notification com.newx.media.view refreshes.
     * Do not need to care about the number of headview, only need to pass in the position of the final com.newx.media.view
     * @param position
     */
    ...
    /**
     * if show empty com.newx.media.view will be return 1 or not will be return 0
     *
     * @return
     */
    ...
    /**
     * Called when a com.newx.media.view created by this adapter has been attached to a window.
     ...
     * is vertical, the com.newx.media.view will have full width; if orientation is horizontal, the com.newx.media.view will
     * have full height.
     * if the hold com.newx.media.view use StaggeredGridLayoutManager they should using all span area
     *
    ...
    /**
     * if asFlow is true, footer/header will arrange like normal item com.newx.media.view.
     ...
     *
     * @param view com.newx.media.view
    ...
    /**
     * Add header com.newx.media.view to mHeaderLayout and set header com.newx.media.view position in mHeaderLayout.
    ...
    /**
     * Add footer com.newx.media.view to mFooterLayout and set footer com.newx.media.view position in mFooterLayout.
    ...
    /**
     * remove header com.newx.media.view from mHeaderLayout.
    ...
    /**
     * remove footer com.newx.media.view from mFooterLayout,
    ...
    /**
     * remove all header com.newx.media.view from mHeaderLayout and set null to mHeaderLayout
     */
    ...
    /**
     * remove all footer com.newx.media.view from mFooterLayout and set null to mFooterLayout
     */
    ...
    private int getHeaderViewPosition() {
        //Return to header com.newx.media.view notify position
        if (getEmptyViewCount() == 1) {
    ...
    private int getFooterViewPosition() {
        //Return to footer com.newx.media.view notify position
        if (getEmptyViewCount() == 1) {
            int position = 1;
            if (mHeadAndEmptyEnable && getHeaderLayoutCount() != 0) {
                position++;
    ...
    /**
     * Set whether to use empty com.newx.media.view
     *
     * @param isUseEmpty
     */
    ...
    /**
     * When the current adapter is empty, the BaseQuickAdapter can display a special com.newx.media.view
     * called the empty com.newx.media.view. The empty com.newx.media.view is used to provide feedback to the user
     * that no data is available in this AdapterView.
     *
     * @return The com.newx.media.view to show if the adapter is empty.
     */
     ...
     * @param parent      Optional com.newx.media.view to be the parent of the generated hierarchy or else simply an object that
     *                    provides a set of LayoutParams values for root of the returned
     *                    hierarchy
     * @return com.newx.media.view will be return
     */
    ...
    /**
     * Set the com.newx.media.view animation type.
     *
    ...
    /**
     * Implement this method and use the helper to adapt the com.newx.media.view to the given item.
     *
    ...
    /**
     * get the specific com.newx.media.view by position,e.g. getViewByPosition(2, R.id.textView)
     * <p>
     * bind recyclerView {@link #bindToRecyclerView(RecyclerView)} before use!
     *
     * @see #bindToRecyclerView(RecyclerView)
...
//            subItemCount += list.size();
     ...
     * com.newx.media.view has been clicked
     */
    public interface OnItemChildClickListener {
        /**
         * callback method to be invoked when an item in this com.newx.media.view has been
         * click and held
         *
         * @param view     The com.newx.media.view whihin the ItemView that was clicked
         * @param position The position of the com.newx.media.view int the adapter
         */
     ...
     * com.newx.media.view has been clicked and held.
     */
    ...
    public interface OnItemLongClickListener {
         ...
         * @param view     The com.newx.media.view whihin the RecyclerView that was clicked and held.
         * @param position The position of the com.newx.media.view int the adapter
         * @return true if the callback consumed the long click ,false otherwise
         */
    ...
    public interface OnItemClickListener {
         ...
         *                 will be a com.newx.media.view provided by the adapter)
         * @param position The position of the com.newx.media.view in the adapter.
         */
