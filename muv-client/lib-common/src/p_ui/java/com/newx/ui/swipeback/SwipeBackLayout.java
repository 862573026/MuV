...
public class SwipeBackLayout extends FrameLayout {
    ...
    /**
     * A com.newx.media.view is not currently being dragged or animating as a result of a
     * fling/snap.
     */
    public static final int STATE_IDLE = ViewDragHelper.STATE_IDLE;

    /**
     * A com.newx.media.view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = ViewDragHelper.STATE_DRAGGING;

    /**
     * A com.newx.media.view is currently settling into place as a result of a fling or
    ...
    /**
     * Enable edge tracking for the selected edges of the parent com.newx.media.view.
    ...
    /**
     * Add a callback to be invoked when a swipe event is sent to this com.newx.media.view.
     *
     * @param listener the swipe com.newx.media.listener to attach to this com.newx.media.view
     */
    ...
    /**
     * Removes a com.newx.media.listener from the set of listeners
     *
     * @param listener
     */
    ...
    public interface OnSwipeListener {
         ...
         *
         * @param scrollPercent scroll percent of this com.newx.media.view
         */
