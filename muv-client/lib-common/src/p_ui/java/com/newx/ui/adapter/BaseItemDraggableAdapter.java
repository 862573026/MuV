...
import com.newx.ui.adapter.callback.ItemDragAndSwipeCallback;
import com.newx.ui.adapter.listener.OnItemDragListener;
import com.newx.ui.adapter.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    /**
     * Set the toggle com.newx.media.view's id which will trigger drag event.
     * If the toggle com.newx.media.view id is not set, drag event will be triggered when the item is long pressed.
     *
     * @param toggleViewId the toggle com.newx.media.view's id
     */
    ...
    /**
     * Enable drag items. Use the specified com.newx.media.view as toggle.
     *
     * @param itemTouchHelper {@link ItemTouchHelper}
     * @param toggleViewId    The toggle com.newx.media.view's id.
