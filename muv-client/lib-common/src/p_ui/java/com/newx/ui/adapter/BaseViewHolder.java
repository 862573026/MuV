...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * use itemView instead
     *
     * @return the ViewHolder root com.newx.media.view
     */
    @Deprecated
     ...
     *
     * @param viewId The com.newx.media.view id.
     * @param value  The text to put in the text com.newx.media.view.
    ...
    /**
     * Will set background color of a com.newx.media.view.
     *
     * @param viewId The com.newx.media.view id.
    ...
    /**
     * Will set background of a com.newx.media.view.
     *
     * @param viewId        The com.newx.media.view id.
    ...
    /**
     * Add an action to set the image of an image com.newx.media.view. Can be called multiple times.
     */
    ...
    /**
     * Add an action to set the alpha of a com.newx.media.view. Can be called multiple times.
     * Alpha between 0-1.
     */
    ...
    /**
     * Set a com.newx.media.view visibility to VISIBLE (true) or GONE (false).
     *
     * @param viewId  The com.newx.media.view id.
    ...
    /**
     * Set a com.newx.media.view visibility to VISIBLE (true) or INVISIBLE (false).
     *
     * @param viewId  The com.newx.media.view id.
    ...
    /**
     * Sets the on click com.newx.media.listener of the com.newx.media.view.
     *
     * @param viewId   The com.newx.media.view id.
     * @param listener The on click com.newx.media.listener;
     * @return The BaseViewHolder for chaining.
     */
    @Deprecated
     ...
     * add childView id
     *
     * @param viewId add the child com.newx.media.view id   can support childview click
     * @return if you use adapter bind com.newx.media.listener
     * @link {(adapter.setOnItemChildClickListener(com.newx.media.listener))}
     * <p>
    ...
    /**
     * add long click com.newx.media.view id
     *
     * @param viewId
     * @return if you use adapter bind com.newx.media.listener
     * @link {(adapter.setOnItemChildLongClickListener(com.newx.media.listener))}
     * <p>
     * or if you can use  recyclerView.addOnItemTouch(listerer)  wo also support this menthod
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Sets the on touch com.newx.media.listener of the com.newx.media.view.
     *
     * @param viewId   The com.newx.media.view id.
     * @param listener The on touch com.newx.media.listener;
     * @return The BaseViewHolder for chaining.
     */
    @Deprecated
    ...
    /**
     * Sets the on long click com.newx.media.listener of the com.newx.media.view.
     *
     * @param viewId   The com.newx.media.view id.
     * @param listener The on long click com.newx.media.listener;
     * @return The BaseViewHolder for chaining.
     * Please use {@link #addOnLongClickListener(int)} (adapter.setOnItemChildLongClickListener(com.newx.media.listener))}
     */
    @Deprecated
    ...
    /**
     * Sets the listview or gridview's item click com.newx.media.listener of the com.newx.media.view
     *
     * @param viewId   The com.newx.media.view id.
     * @param listener The item on click com.newx.media.listener;
     * @return The BaseViewHolder for chaining.
     * Please use {@link #addOnClickListener(int)} (int)} (adapter.setOnItemChildClickListener(com.newx.media.listener))}
     */
    @Deprecated
    ...
    /**
     * Sets the listview or gridview's item long click com.newx.media.listener of the com.newx.media.view
     *
     * @param viewId   The com.newx.media.view id.
     * @param listener The item long click com.newx.media.listener;
     * @return The BaseViewHolder for chaining.
     */
    ...
    /**
     * Sets the listview or gridview's item selected click com.newx.media.listener of the com.newx.media.view
     *
     * @param viewId   The com.newx.media.view id.
     * @param listener The item selected click com.newx.media.listener;
     * @return The BaseViewHolder for chaining.
     */
    ...
    /**
     * Sets the on checked change com.newx.media.listener of the com.newx.media.view.
     *
     * @param viewId   The com.newx.media.view id.
     * @param listener The checked change com.newx.media.listener of compound button.
     * @return The BaseViewHolder for chaining.
     */
    ...
    /**
     * Sets the tag of the com.newx.media.view.
     *
     * @param viewId The com.newx.media.view id.
     * @param tag    The tag;
     * @return The BaseViewHolder for chaining.
    ...
    /**
     * Sets the adapter of a adapter com.newx.media.view.
     *
     * @param viewId  The com.newx.media.view id.
    ...
    /**
     * Retrieves the last converted object on this com.newx.media.view.
     */
