package com.newx.ui.searchview.suggestions;
...
public class SearchSuggestionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchSuggestionsAdapter(Context context, int suggestionTextSize, Listener listener) {
        ...
        mRightIconDrawable = Util.getWrappedDrawable(mContext, R.drawable.ic_arrow_back_black);
        DrawableCompat.setTint(mRightIconDrawable, Util.getColor(mContext, R.color.gray_78));
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_searchview_suggestion, viewGroup, false);
