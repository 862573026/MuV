package com.newx.ui.objectanimator;
...
public class ViewPropertyObjectAnimator {
    ...
    private boolean initMarginListener() {
        //we're initializing margin com.newx.media.listener only when needed (it can cause an exception when there are no params)
    ...
    private boolean initDimensionListener() {
        //we're initializing dimension com.newx.media.listener only when needed (it can cause an exception when there are no params)
