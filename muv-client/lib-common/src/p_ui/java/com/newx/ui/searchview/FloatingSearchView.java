package com.newx.ui.searchview;
...
import com.newx.ui.objectanimator.ViewPropertyObjectAnimator;
import com.newx.ui.searchview.suggestions.SearchSuggestionsAdapter;
import com.newx.ui.searchview.suggestions.model.SearchSuggestion;
import com.newx.ui.searchview.util.Util;
import com.newx.ui.searchview.util.adapter.GestureDetectorListenerAdapter;
import com.newx.ui.searchview.util.adapter.OnItemTouchListenerAdapter;
import com.newx.ui.searchview.util.adapter.TextWatcherAdapter;
import com.newx.ui.searchview.util.view.MenuView;
import com.newx.ui.searchview.util.view.SearchInputView;
...
public class FloatingSearchView extends FrameLayout {
    ...
    //An interface for implementing a com.newx.media.listener that will get notified when the suggestions
    ...
    /**
     * Interface for implementing a com.newx.media.listener to listen to
    ...
    /**
     * Interface for implementing a com.newx.media.listener to listen
    ...
    private void init(AttributeSet attrs) {
        ...
        mMainLayout = inflate(getContext(), R.layout.layout_floating_search, this);
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            setLeftActionIconColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_leftActionColor
                    , Util.getColor(getContext(), R.color.gray_78)));
            ...
            setDividerColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_dividerColor
                    , Util.getColor(getContext(), R.color.white_f0)));
     ...
     * com.newx.media.view including the suggestions section.
     *
    ...
    /**
     * Set a callback that will be called after each suggestion com.newx.media.view in the suggestions recycler
    ...
    private void setSearchFocusedInternal(final boolean focused) {
        ...
        //screen-covering com.newx.media.view to handle touches
    ...
    /**
     * Sets the com.newx.media.listener that will be notified when the suggestion list's height
     * changes.
     *
    ...
    /**
     * Sets the com.newx.media.listener that will listen for query
     * changes as they are being typed.
     *
     * @param listener com.newx.media.listener for query changes
     */
    ...
    /**
     * Sets the com.newx.media.listener that will be called when
     ...
     *
     * @param listener com.newx.media.listener for query completion
     */
    ...
    /**
     * Sets the com.newx.media.listener that will be called when the focus
     * of the search has changed.
     *
     * @param listener com.newx.media.listener for search focus changes
     */
    ...
    /**
     * Sets the com.newx.media.listener that will be called when the
     * left/start menu (or navigation menu) is clicked.
     * <p/>
     * <p>Note that this is different from the overflow menu
     * that has a separate com.newx.media.listener.</p>
     *
     * @param listener
     */
     ...
     *
     * @param listener com.newx.media.listener to listen to menu item clicks
     */
    public void setOnMenuItemClickListener(OnMenuItemClickListener listener) {
        this.mActionMenuItemListener = listener;
        //todo reset menu com.newx.media.view com.newx.media.listener
    }
