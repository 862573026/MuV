 ...
 * with com.newx.media.view types and com.newx.media.view recycling.
 */
public abstract class RecyclingPagerAdapter extends PagerAdapter {
	 ...
	 *            com.newx.media.view type we want.
	 ...
	 * to specify a root com.newx.media.view and to prevent attachment to the root.
	 * 
	 * @param position
	 *            The position of the item within the adapter's data set of the
	 *            item whose com.newx.media.view we want.
	 * @param convertView
	 *            The old com.newx.media.view to reuse, if possible. Note: You should check
	 *            that this com.newx.media.view is non-null and of an appropriate type before
	 *            using. If it is not possible to convert this com.newx.media.view to display
	 *            the correct data, this method can create a new com.newx.media.view.
	 *            Heterogeneous lists can specify their number of com.newx.media.view types, so
	 *            that this View is always of the right type (see
	 *            {@link #getViewTypeCount()} and {@link #getItemViewType(int)}
	 *            ).
	 * @param container
	 *            The parent that this com.newx.media.view will eventually be attached to
