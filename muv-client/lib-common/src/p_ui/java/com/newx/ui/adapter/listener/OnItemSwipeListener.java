...
public interface OnItemSwipeListener {
     ...
     * If you change the com.newx.media.view on the start, you should reset is here, no matter the item has swiped or not.
     *
     * @param pos If the com.newx.media.view is swiped, pos will be negative.
     */
    void clearView(RecyclerView.ViewHolder viewHolder, int pos);

    /**
     * Called when item is swiped, the com.newx.media.view is going to be removed from the adapter.
     */
     ...
     * @param isCurrentlyActive True if this com.newx.media.view is currently being controlled by the user or
