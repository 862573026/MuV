package com.newx.ui.refreshlayout;
...
import com.newx.ui.refreshlayout.api.DefaultRefreshFooterCreator;
import com.newx.ui.refreshlayout.api.DefaultRefreshHeaderCreator;
import com.newx.ui.refreshlayout.api.RefreshContent;
import com.newx.ui.refreshlayout.api.RefreshFooter;
import com.newx.ui.refreshlayout.api.RefreshHeader;
import com.newx.ui.refreshlayout.api.RefreshInternal;
import com.newx.ui.refreshlayout.api.RefreshKernel;
import com.newx.ui.refreshlayout.api.RefreshLayout;
import com.newx.ui.refreshlayout.api.ScrollBoundaryDecider;
import com.newx.ui.refreshlayout.constant.DimensionStatus;
import com.newx.ui.refreshlayout.constant.RefreshState;
import com.newx.ui.refreshlayout.constant.SpinnerStyle;
import com.newx.ui.refreshlayout.footer.BallPulseFooter;
import com.newx.ui.refreshlayout.header.BezierRadarHeader;
import com.newx.ui.refreshlayout.impl.RefreshContentWrapper;
import com.newx.ui.refreshlayout.impl.RefreshFooterWrapper;
import com.newx.ui.refreshlayout.impl.RefreshHeaderWrapper;
import com.newx.ui.refreshlayout.listener.OnLoadMoreListener;
import com.newx.ui.refreshlayout.listener.OnMultiPurposeListener;
import com.newx.ui.refreshlayout.listener.OnRefreshListener;
import com.newx.ui.refreshlayout.listener.OnRefreshLoadMoreListener;
import com.newx.ui.refreshlayout.listener.OnStateChangedListener;
import com.newx.ui.refreshlayout.util.DelayedRunnable;
import com.newx.ui.refreshlayout.util.DensityUtil;
import com.newx.ui.refreshlayout.util.ScrollBoundaryUtil;
import com.newx.ui.refreshlayout.util.ViscousFluidInterpolator;
...
import static com.newx.ui.refreshlayout.util.DensityUtil.dp2px;
import static com.newx.ui.refreshlayout.util.SmartUtil.fling;
import static com.newx.ui.refreshlayout.util.SmartUtil.getColor;
import static com.newx.ui.refreshlayout.util.SmartUtil.isScrollableView;
...
//        mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    protected void onFinishInflate() {
        ...
        if (count > 3) {
            throw new RuntimeException("最多只支持3个子View，Most only support three sub com.newx.media.view");
        }
...
//            if (index < count) {
//                View com.newx.media.view = super.getChildAt(index);
//                if (!(com.newx.media.view instanceof RefreshInternal)) {
//                    indexContent = index;
//                }
//                if (isScrollableView(com.newx.media.view)) {
//                    indexContent = index;
//                    break;
//                }
//            }
...
//                mRefreshContent = new RefreshContentWrapper(com.newx.media.view);
            }
        }
...
//        // if this is a List < L or another com.newx.media.view that doesn't support nested
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.newx.ui.refreshlayout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.newx.ui.refreshlayout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
