...
import com.newx.muv.main.databinding.ActivityTabBinding;
...
public class TabActivity extends NxBindingActivity<ActivityTabBinding> {
    ...
    private void initView() {
        ...
        centerView.setOnClickListener(v -> JumpHelper.fragment(RP.UploadFragment).navigation());
...
//        });
    ...
    private class TabAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter {
        ...
        public Fragment getFragmentForPage(int position) {
            switch (position) {
                case 0:
                    return MiddlewareProxy.findFragment(RP.MuVRootFragment);
                case 1:
                    return MiddlewareProxy.findFragment(RP.FocusFragment);
                case 2:
                    return MiddlewareProxy.findFragment(RP.ClassifyFragment);
                case 3:
                    return MiddlewareProxy.findFragment(RP.MeRootFragment);
            }
            return null;
        }
    }
