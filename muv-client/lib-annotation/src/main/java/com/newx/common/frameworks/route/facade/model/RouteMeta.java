package com.newx.common.frameworks.route.facade.model;
...
/**
 * It contains basic com.newx.common.frameworks.route information.
 *
...
public class RouteMeta {
    private RouteType type;         // Type of com.newx.common.frameworks.route
    private Element rawType;        // Raw type of com.newx.common.frameworks.route
    private Class<?> destination;   // Destination
    private String path;            // Path of com.newx.common.frameworks.route
    private String group;           // Group of com.newx.common.frameworks.route
     ...
     * Type
     *
     * @param route       com.newx.common.frameworks.route
     * @param destination destination
     * @param type        type
     */
