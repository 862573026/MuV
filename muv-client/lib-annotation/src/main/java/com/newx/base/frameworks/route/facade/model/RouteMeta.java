package com.newx.base.frameworks.route.facade.model;
...
/**
 * It contains basic com.newx.base.frameworks.route information.
 *
...
public class RouteMeta {
    private RouteType type;         // Type of com.newx.base.frameworks.route
    private Element rawType;        // Raw type of com.newx.base.frameworks.route
    private Class<?> destination;   // Destination
    private String path;            // Path of com.newx.base.frameworks.route
    private String group;           // Group of com.newx.base.frameworks.route
     ...
     * Type
     *
     * @param route       com.newx.base.frameworks.route
     * @param destination destination
     * @param type        type
     */
