...
import com.newx.annotation.Action;
import com.newx.annotation.Module;
import com.newx.annotation.Modules;
...
public class ActionPrecessor extends AbstractProcessor {
    ...
    private void generateDefaultProviderMappingInit() {
        ...
        TypeSpec providerInit = TypeSpec.classBuilder("ProviderInit")
                ...
                .build();
        try {
            JavaFile.builder(Consts.PACKAGE_OF_GENERATE_FILE, providerInit)
                    .build()
                    .writeTo(filer);
        } catch (Throwable e) {
            e.printStackTrace();
