...
import { roleList, addRole } from '@/api/role'
...
const calendarTypeKeyValue = enableOptions.reduce((acc, cur) => {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        enable: [{ required: true, message: 'type is required', trigger: 'change' }]
      },
